...
fun ApplicationMigrationStatus.toDgs(appName: String) = MD_Migration(
  ...
  deliveryConfig = autoGeneratedConfig,
  prLink = prLink,
  pipelines = pipelines.toDgs(),
  userGeneratedConfig = userGeneratedConfig?.let { MD_UserGeneratedConfig(
    id = "user-generated-config-$appName",
    deliveryConfig = it.config,
